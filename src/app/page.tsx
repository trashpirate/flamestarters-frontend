...
export default function Home() {
  return (
    <main className="flex h-screen flex-col justify-items-stretch bg-black bg-scroll py-4 text-black bg-blend-darken">
      <div className="mx-auto h-full w-full flex-col items-center justify-between xl:w-5/6">
        ...
        <div className="mt-8 grid w-full grid-cols-1 justify-between justify-items-stretch gap-4 md:grid-cols-3">
